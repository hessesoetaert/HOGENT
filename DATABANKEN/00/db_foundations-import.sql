-- ***************************************************************
-- This script creates and populates all sample tables (and the one view)
-- of the DATABASE FOUNDATIONS Oracle Academy course.
-- This SQL-script is optimized for a MySQL Server.
-- ***************************************************************

-- Als er reeds een database met de naam "db_foundations" bestaat
-- op je MySQL-server, dan zal dit script falen.
-- Dat is voor de veiligheid, zodat je niet per ongeluk
-- een bestaande databank overschrijft.

-- Weet je zeker dat je de bestaande "db_foundations"-database
-- volledig wilt wissen en vervangen door een nieuwe versie?
-- Voer dan eerst het SQL-commando "DROP DATABASE db_foundations;" uit.
...
-- SET lower_case_table_names = 1;  -- this variable seems to be read-only
